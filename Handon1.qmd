[**Google colab - Hand on 1**](https://colab.research.google.com/drive/1dBAJIj7b9OTsrYizAsetouuweawdJG_q?usp=sharing)
...
2.  **Create Synthetic Data:** Generate some synthetic data that represents a complex function. For this example, we'll use a sine wave with added noise.
...
3.  **Define the Neural Network:** Create a neural network with three hidden layers.
...
4.  **Define Loss and Optimizer:** Choose a loss function and an optimizer.
...
5.  **Train the Model:** Train the neural network on the synthetic data.
...
6.  **Evaluate the Model:** Evaluate the model's performance.
